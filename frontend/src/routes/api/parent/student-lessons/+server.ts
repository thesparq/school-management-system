...
export const GET: RequestHandler = async (event) => {
	...
	params.subject_id = event.url.searchParams.get("subject_id") || "";
	params.term_id = event.url.searchParams.get("term_id") || "";
	

	const result = await proxyToParent(user.id, '/student-lessons', params);
