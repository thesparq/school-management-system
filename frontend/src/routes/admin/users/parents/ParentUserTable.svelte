...
<Dialog open={showCreateDialog} onOpenChange={(v: boolean) => v ? null : closeCreate()}>
	<DialogContent class="sm:max-w-lg"><DialogHeader><DialogTitle>Create Parent</DialogTitle></DialogHeader>
		<div class="space-y-4">
			...
			<div class="space-y-2"><Label>Full Name <span class="text-error-500">*</span></Label><Input bind:value={createForm.name} required /></div>
			...
			<div class="space-y-2">
				<Label>Linked Students <span class="text-error-500">*</span></Label>
				{#if studentListLoading}<p class="text-sm text-surface-400">Loading students...</p>{:else}
...
<Dialog open={editDialogOpen} onOpenChange={(v: boolean) => v ? null : closeEdit()}>
	<DialogContent class="sm:max-w-lg"><DialogHeader><DialogTitle>Edit Parent</DialogTitle></DialogHeader>
		<div class="space-y-4">{#if editProfileLoading}<div class="text-sm text-surface-400">Loading...</div>{/if}
			...
			<div class="space-y-2"><Label>Full Name <span class="text-error-500">*</span></Label><Input bind:value={editForm.name} required /></div>
			...
			<div class="space-y-2"><Label>Linked Students <span class="text-error-500">*</span></Label>
